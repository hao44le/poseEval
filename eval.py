...
ground_truth_content = open('csv/TownCentre-groundtruth.csv')

def calculate_metric_from_a_pred_file(pred_file):
    pred_content = open(pred_file)
...
# calculate_metric_from_a_pred_file("csv/1b.csv")
